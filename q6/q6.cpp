...
void* sensor(int id){
    ...
    while(true){
        ...
        // COntando que o sensor consumiu mais uma mala
        amountLuggagePassed++:
        ...
        if(counterExecution == MAX_LUGGAGE){
            ...
            amountEnableSensors--;
            pthread_cond_wait(A_BARREIRA_DE_MANUTENCAO);
            amountEnableSensors++;
